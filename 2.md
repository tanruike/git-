...
![image-20230316172306884](/Users/tanruike/Library/Application Support/typora-user-images/image-20230316172306884.png)
...
![image-20230316172653246](/Users/tanruike/Library/Application Support/typora-user-images/image-20230316172653246.png)
...
![image-20230317104046265](/Users/tanruike/Library/Application Support/typora-user-images/image-20230317104046265.png)

可以看到有一个修改为暂存的文件。那么输入`git diff`呢？

![image-20230317104232292](/Users/tanruike/Library/Application Support/typora-user-images/image-20230317104232292.png)
...
![image-20230317104904463](/Users/tanruike/Library/Application Support/typora-user-images/image-20230317104904463.png)

你可以在上面输入你这次提交的主要变更内容，以便于给其他开发者一个提示。

![image-20230317104950251](/Users/tanruike/Library/Application Support/typora-user-images/image-20230317104950251.png)

然后按`esc` 然后输入 ：wq保存退出

![image-20230317105042750](/Users/tanruike/Library/Application Support/typora-user-images/image-20230317105042750.png)

这将清空你的暂存区。

当然上述的步骤有点复杂，你可以可以在提交的时候直接在命令行键入提示信息。
